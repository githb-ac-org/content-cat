...
print_success() {
    ...
    echo ""
    printf "  ${BR_YELLOW}!${RESET} ${DIM}If 'content-cat' is not found, restart your terminal or run:${RESET}\n"
    printf "      ${DIM}source ~/.zshrc${RESET}  ${BR_BLACK}(or ~/.bashrc for bash)${RESET}\n"
    echo ""
    printf "  ${BR_BLACK}─────────────────────────────────────────────────────────────────${RESET}\n"
    echo ""
